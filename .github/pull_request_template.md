...
We are more than welcome contributions to knowledge-base (any type of bugfix, features, proposal, etc.) Most of the maintainers are somewhat the furthest from the "anti-LLM" camp (our professional work encapsulate everything you can think of about LLM).
...
So to be the most productive for all parties, we would encourage any contributors, to at the very least, pay attention to what the model is doing, and make the final call as to whether it makes sense to merge this back upstream into knowledge-base or not.
